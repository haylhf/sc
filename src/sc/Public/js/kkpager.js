...
var kkpager = {
    ...
    generPageHtml: function (config, enforceInit) {
        ...
        var total_info = '<span class="totalText" style="font-size: 14px;height: 20px;" >';
        ...
        if (this.isGoPage) {
            gopage_info = '<span class="goPageBox">' + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '">' +
                ...
                '<input  type="text" style="height: 20px" id="' + this.gopageTextboxId + '" onfocus="kkpager.focus_gopage()"  onkeypress="return kkpager.keypress_gopage(event);"   onblur="kkpager.blur_gopage()" value="' + this.next + '" /></span>' + this.lang.gopageAfterText + '</span>';
        }
